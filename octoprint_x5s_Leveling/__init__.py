    ...
    def get_update_information(self):
        ...
        return dict(
            X5S_Leveling=dict(
                ...
                type="github_release",
                user="TemplarGalactic",
                repo="x5s_leveling_octoprinT",
                current=self._plugin_version,

                # update method: pip
                pip="https://github.com/TemplarGalactic/x5s_leveling_octoprint/archive/{target_version}.zip"
            )
        )


__plugin_name__ = "X5S Leveling Plugin"


def __plugin_load__():
    global __plugin_implementation__
    __plugin_implementation__ = X5S_levelingPlugin()
